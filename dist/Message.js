...
var _Watermark = __webpack_require__(2);
...
var Watermark = function (_Meister$ProtoPlugin) {
    _inherits(Watermark, _Meister$ProtoPlugin);

    function Watermark(config, meister) {
        _classCallCheck(this, Watermark);

        var _this = _possibleConstructorReturn(this, (Watermark.__proto__ || Object.getPrototypeOf(Watermark)).call(this, config, meister));
        ...
        if (!config.iconUrl) {
            ...
            return _ret = [], _possibleConstructorReturn(_this, _ret);
        }

        _this.watermarkDrawn = false;

        _this.on('playerPlaying', _this.onPlayerPlaying.bind(_this));
        return _this;
    }
    ...
    _createClass(Watermark, [{
        ...
        value: function onPlayerPlaying() {
            ...
            if (this.config.style) {
                Object.keys(this.config.style).forEach(function (key) {
                    watermarkElement.style[key] = _this2.config.style[key];
                });
            }
...
var update = __webpack_require__(4)(content, {"sourceMap":true});
...
module.exports = {
	"name": "@meisterplayer/plugin-watermark",
	"version": "5.1.0",
	"description": "Watermark plugin for Meister",
